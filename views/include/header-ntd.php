...
$query = "select * from user_ntd where  email='$email1' ";
		...
		<div class="container">
			<div class="row">
				<div class="col-md-2 col-12">
					<a href="index_ntd.php" class="logo-main"><img src="../assets/img/logo.png" alt="" class=""></a>
				</div>
				<div class="col-md-7">
...
<!-- 						<a class="info">
						...
						<div class="dropdown">
							...
							<a class="btn btn-outline-secondary dropdown-toggle info" href="#" role="button" id="dropdowntk" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
								<span class="name"><?php echo $_SESSION['email']; ?></span>
							</a>
							<div class="dropdown-menu" aria-labelledby="dropdowntk">
								<a class="dropdown-item" href="../views/dangtintuyendung.php?id_ntd=<?php echo $result['id_ntd'];?>">Đăng tin tuyển dụng</a>
				...
				<div class="col-md-12">
					<div class="collapse navbar-collapse" id="navbarSupportedContent1">
						<ul class="navbar-nav mr-auto">
							<li class="nav-item">
								<a class="nav-link home-link" href="index_ntd.php"><i class="fa fa-home"></i>TRANG CHỦ</a>
							</li>
							<li class="nav-item cn">
								...
								<ul class="navbar-nav menu-kid collapse" id="chuyennganh-con" >
									...
									$query = "select * from chuyen_nganh ";
										...
										<a class='nav-link' href='../views/chuyen_nganh_ntd.php?id_chuyen_nganh=".$row["id_chuyen_nganh"]."'> ".$row['ten_chuyen_nganh']."</a>
										</li>";
									}
									?>
							</ul>
